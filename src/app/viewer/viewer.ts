...
export default class Viewer {
  ...
  constructor(private mainElem: ShadowRoot) {
    this.container = this.mainElem.getElementById('viewer-container')!;

    this.svgElem = this.mainElem.querySelector<SVGGraphicsElement>('#viewer')!;
  ...
  private relationClick = (relationData: Relation): void => {
