...
export class DbViewer extends HTMLElement {
  ...
  private onRelationClick = (relationData: Relation): void => {
  ...
  override addEventListener<K extends keyof DbViewerEventMap>(
    type: K,
  ...
  override removeEventListener<K extends keyof DbViewerEventMap>(
    type: K,
